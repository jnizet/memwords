...
<div id="resume">
  ...
  <p>Où que vous soyez, connectez-vous à MemWords avec votre mot de passe principal, et retrouvez tous les 
     mots de passe que vous y avez stockés.</p>
  <p style="font-size: x-large;"><stripes:link beanclass="com.googlecode.memwords.web.ScreenshotsActionBean">Jetez 
    un coup d'oeil aux copies d'écran&nbsp;!</stripes:link></p>
</div>
<div id="features">
  <h2>Points clés</h2>
  <ul>
...
<div id="faq">
  ...
  <div class="question">
    Et l'administrateur de l'application&nbsp;? S'il consulte la base de données, il va y trouver mes 
    mots de passe, non&nbsp;?
  </div>
  <div class="answer">
    Non. La plupart des informations dans la base de données sont encryptées&nbsp;: les mots de passe, 
    mais aussi les identifiants, les URLs, les notes, les icônes.
  </div>
  <div class="question">
    C'est encrypté, mais l'administrateur doit forcément connaître la clé, sinon les informations ne pourraient 
    pas être décryptées, n'est-ce pas&nbsp;?
  </div>
  <div class="answer">
    Non. La clé utilisée pour encrypter <em>vos</em> informations est protégée par <em>votre</em> mot de 
    passe principal, que vous êtes le seul à connaître.<br/>
    <a href="http://code.google.com/p/memwords/wiki/Security" class="external">Plus d'informations sur la sécurité 
    dans MemWords</a>
  </div>
  <div class="question">
  ...
  <div class="answer">
    Première raison&nbsp;: MemWords est un projet développé comme un hobby, hébergé gratuitement par 
    <a href="http://code.google.com/appengine/">Google App Engine</a>. Et Google App Engine ne supporte 
    pas AES-256.<br/>
    Deuxième raison&nbsp;: AES-128 est suffisamment sûr. Votre mot de passe principal est le maillon le 
    plus faible, quoi qu'il en soit. Si vous êtes vraiment craintif quant à vos mots de passe, ne les 
    stockez que dans votre cerveau.
  </div>
  <div class="question">
    Que se passe-t-il si mon mot de passe principal est compromis&nbsp;?
  </div>
  <div class="answer">
    Pas de chance. Vous pouvez toujours le changer avant qu'il ne soit trop tard, ou détruire votre compte. La 
    sécurité de votre compte dépend de la force de votre mot de passe principal. Choisissez-en un compliqué, et 
    gardez-le pour vous.
  </div>
  <div class="question">
