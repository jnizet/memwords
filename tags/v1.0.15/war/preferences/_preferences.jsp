<div id="preferences">
  ...
  <div>
    <stripes:link beanclass="com.googlecode.memwords.web.preferences.ChangePreferredLocaleActionBean"
                  ...
                  class="icon changePreferredLocale"><fmt:message key="preferences._preferences.changePreferredLocale"/></stripes:link>
  </div>
  ...
  <div>
    <stripes:link beanclass="com.googlecode.memwords.web.preferences.ChangePreferredTimeZoneActionBean"
                  ...
                  class="icon changePreferredTimeZone"><fmt:message key="preferences._preferences.changePreferredTimeZone"/></stripes:link>
  </div>
  ...
  <div>
    <stripes:link beanclass="com.googlecode.memwords.web.preferences.ChangePasswordPreferencesActionBean" 
                  ...
                  class="icon changePasswordPreferences"><fmt:message key="preferences._preferences.changePasswordPreferences"/></stripes:link>
  </div>
  ...
  <div>
    <stripes:link beanclass="com.googlecode.memwords.web.preferences.ChangePasswordGenerationPreferencesActionBean" 
                  ...
                  class="icon changePasswordGenerationPreferences"><fmt:message key="preferences._preferences.changePasswordGenerationPreferences"/></stripes:link>
  </div>
