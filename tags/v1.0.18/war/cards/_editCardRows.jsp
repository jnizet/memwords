...
<tr>
  <th class="topText"><label class="required" for="password"><fmt:message 
    key="cards._editCardRows.passwordLabel"/></label></th>
  <td>
    <c:if test="${actionBean.modification}">
      <span id="changePasswordSpan">
        <stripes:checkbox name="changePassword" id="changePasswordCheckBox"/><label 
          for="changePasswordCheckBox"><fmt:message key="cards._editCardRows.changePasswordCheckBox"/></label>
      </span>
    </c:if>
    <stripes-d:password name="password" 
                        autocomplete="off" 
                        repopulate="${!actionBean.modification 
                                      || (actionBean.modification && actionBean.changePassword)}" 
                        id="password"/>
    ...
    <div id="generatePasswordLinksDiv" style="display: none;">
      ...
      <a href="#" id="generatePasswordWithOptionsLink"><fmt:message 
        key="cards._editCardRows.generatePasswordWithOptionsLink"/></a>
    </div>
...
<tr>
  ...
  <td>
     ...
     <a class="external" style="display: none;" id="testUrlLink" target="_blank" href="#"><fmt:message 
       key="cards._editCardRows.testUrlLink"/></a>
  </td>
</tr>
<tr>
