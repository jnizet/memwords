...
<div id="resume">
  ...
  <p>Anywhere you are, log in to MemWords using your master password, and find all the passwords you have 
     previously stored.</p>
  <p style="font-size: x-large;"><stripes:link beanclass="com.googlecode.memwords.web.ScreenshotsActionBean">Look 
     at screenshots!</stripes:link></p>
</div>
<div id="features">
  <h2>Features</h2>
  <ul>
...
<div id="faq">
  ...
  <div class="answer">
    No. Most of the information in the database is encrypted: the passwords, but also the logins, notes, URLs, 
    icons, etc.
  </div>
  <div class="question">
  ...
  <div class="answer">
    No. The key used to encrypt <em>your</em> information is protected by <em>your</em> master password, that you're 
    the only one to know.<br/>
    <a href="http://code.google.com/p/memwords/wiki/Security" class="external">More information about security in 
    MemWords</a>
  </div>
  <div class="question">
  ...
  <div class="answer">
    First reason: MemWords is a hobby project, hosted freely on <a href="http://code.google.com/appengine/">Google 
    App Engine</a>. And Google App Engine doesn't support AES-256.<br/>
    Second reason: AES-128 is secure enough. Your master password is the weakest link anyway. If you're really 
    paranoid about your passwords, don't store them anywhere but your brain.
  </div>
  <div class="question">
